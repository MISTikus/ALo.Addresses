    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_AddressId_ActualityStatus",
                schema: "dbo",
                table: "Addresses",
                columns: new[] { "AddressId", "ActualityStatus" });

            migrationBuilder.CreateIndex(
                name: "IX_Addresses_ParentAddressId_ActualityStatus",
                schema: "dbo",
                table: "Addresses",
                columns: new[] { "ParentAddressId", "ActualityStatus" });

            migrationBuilder.CreateIndex(
                name: "IX_Houses_AddressId_EndDate",
                schema: "dbo",
                table: "Houses",
                columns: new[] { "AddressId", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Houses_HouseId_EndDate",
                schema: "dbo",
                table: "Houses",
